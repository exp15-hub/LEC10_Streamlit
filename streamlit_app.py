...
data = {
    "항목": march_dates,
    "값(hour)": [4.0, 0.0, 8.2, 4.5, 7.0, 5.5, 6.25, 8.5, 5.3, 10.2, 5.0, 8.6, 2.75, 10.0, 6.17, 3.0, None, 4.0, None, 4.8, 11.25, 4.67, 5.25, 7.8, None, 7.0, 4.8, None, 6.8, None, 6.5]
}
...
선택값 = df[df["항목"] == 선택]["값(hour)"].values[0]
